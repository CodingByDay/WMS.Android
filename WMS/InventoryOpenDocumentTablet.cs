...
{
    [Activity(Label = "InventoryOpenDocumentTablet", ScreenOrientation = Android.Content.PM.ScreenOrientation.Landscape)]
    public class InventoryOpenDocumentTablet : CustomBaseActivity
    {
